...
<Layout>
<Router>
<Menu mode="horizontal" theme="dark" style={menuStyle} selectedKeys={[]}>
<h1 style={logoStyle}>MetaKeep EOS Tutorial</h1>
<Menu.Item key="create" icon={<PlusOutlined />}>
<Link to="/create" style={linkStyle} activestyle={activeLinkStyle}>
Create
</Link>
</Menu.Item>
<Menu.Item key="transfer" icon={<SwapOutlined />}>
<Link to="/transfer" style={linkStyle} activestyle={activeLinkStyle}>
Transfer
</Link>
</Menu.Item>
</Menu>

...
/**
  ...
  @param {string} [pubkey_prefix = 'FIO']
*/
function PublicKey(Q, pubkey_prefix = 'FIO') {
    if(typeof Q === 'string') {
...
/**
  ...
  @param {string} [pubkey_prefix = 'FIO']
*/
PublicKey.isValid = function(pubkey, pubkey_prefix = 'FIO') {
    try {
...
*/
PublicKey.fromString = function(public_key, pubkey_prefix = 'FIO') {
    try {
...
/**
    ...
    @return PublicKey
*/
PublicKey.fromStringOrThrow = function(public_key, pubkey_prefix = 'FIO') {

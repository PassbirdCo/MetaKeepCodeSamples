...
exports.EOSPubKeyToFIOPubKey = exports.broadcastTx = exports.createRawTx = exports.FIO_ADDRESS_ACCOUNT = exports.ADD_ADDRESS_ACTION = exports.Environment = void 0;
...
const broadcastTx = async ({ rawTx, chainId, account, signature, fioBaseUrl, }) => {
    ...
    Transactions_1.Transactions.abiMap.set(fioAccountAbi.account_name, fioAccountAbi);
    const transaction = new Transactions_1.Transactions();
    ...
    const pushTransactionResponse = await fetch(`${fioBaseUrl}/chain/push_transaction`, {
        method: "POST",

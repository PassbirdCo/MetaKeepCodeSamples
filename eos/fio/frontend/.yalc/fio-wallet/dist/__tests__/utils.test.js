...
Transactions_1.Transactions.abiMap = new Map();
...
describe("createRawTx", () => {
    it("should create a raw transaction", async () => {
        ...
        // Run
        const result = await (0, utils_1.createRawTx)({
            publicKey,
            actionData,
            account,
            action,
        ...
        // Assert
        expect(mockedPost).toHaveBeenCalledWith("https://fiotestnet.blockpane.com/v1/chain/get_info");
        expect(mockedPost).toHaveBeenCalledWith("https://fiotestnet.blockpane.com/v1/chain/get_block", { block_num_or_id: 1234 });
...
describe("broadcastTx", () => {
    it("should broadcast a transaction", async () => {
        ...
        const mockedPost = mockedAxios.post.mockReturnValueOnce(Promise.resolve({ data: mockPushTransactionResponse }));
        // Run
        const result = await (0, utils_1.broadcastTx)({
            rawTx,
            chainId,
            account,
            signature,
        ...
        // Assert
        expect(mockedPost).toHaveBeenCalledWith("https://fiotestnet.blockpane.com/v1/chain/push_transaction", {
            compression: 0,
            packed_context_free_data: "6d6f636b53657269616c697a6564436f6e746578744672656544617461",
...
describe("EOSPubKeyToFIOPubKey", () => {
    it("should convert an EOS public key to a FIO public key", () => {
        ...
        // Run
        const result = (0, utils_1.EOSPubKeyToFIOPubKey)(eosPubKey);
        // Assert

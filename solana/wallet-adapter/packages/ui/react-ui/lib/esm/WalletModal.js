            ...
            React.createElement("div", { className: "wallet-adapter-modal-container" },
                React.createElement("div", { className: "wallet-adapter-modal-wrapper" },
                    ...
                    listedWallets.length ? (React.createElement(React.Fragment, null,
                        React.createElement("span", { className: "wallet-adapter-modal-title" }, "Connect Wallet"),
                        React.createElement("div", null,
                            React.createElement("span", { className: "wallet-adapter-modal-subtitle" }, "You need to connect a Solana wallet.")),
                        React.createElement("hr", { className: "wallet-adapter-modal-line" }),
                        defaultWallet && (React.createElement("div", { className: "wallet-adapter-modal-list" },
                            React.createElement(WalletListItem, { handleClick: (event) => handleWalletClick(event, defaultWallet?.adapter.name), wallet: defaultWallet, isDefault: true }))),
                        listedWallets.length > 1 || collapsedWallets.length ? (React.createElement(React.Fragment, null,
                            React.createElement("button", { className: "wallet-adapter-modal-list-more", onClick: handleCollapseClick, tabIndex: 0 },
                                React.createElement("span", null, "Other options"),
                            ...
                            expanded && (React.createElement("ul", { className: "wallet-adapter-modal-list" }, listedWallets.map((wallet) => (React.createElement(WalletListItem, { key: wallet.adapter.name, handleClick: (event) => handleWalletClick(event, wallet.adapter.name), wallet: wallet, isDefault: wallet === defaultWallet }))))))) : null)) : (React.createElement(React.Fragment, null,
                        ...
                        collapsedWallets.length ? (React.createElement(React.Fragment, null,
                            ...
                            React.createElement(Collapse, { expanded: expanded, id: "wallet-adapter-modal-collapse" },
                                React.createElement("ul", { className: "wallet-adapter-modal-list" }, collapsedWallets.map((wallet) => (React.createElement(WalletListItem, { key: wallet.adapter.name, handleClick: (event) => handleWalletClick(event, wallet.adapter.name), tabIndex: expanded ? 0 : -1, wallet: wallet, isDefault: wallet === defaultWallet }))))))) : null)))),

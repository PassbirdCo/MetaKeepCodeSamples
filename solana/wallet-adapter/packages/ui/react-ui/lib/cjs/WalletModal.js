...
const WalletModal = ({ className = '', container = 'body' }) => {
    ...
    const defaultWallet = collapsedWallets[0];
            ...
            react_1.default.createElement("div", { className: "wallet-adapter-modal-container" },
                react_1.default.createElement("div", { className: "wallet-adapter-modal-wrapper" },
                    react_1.default.createElement("button", { onClick: handleClose, className: "wallet-adapter-modal-button-close" },
                        react_1.default.createElement("svg", { width: "12", height: "12" },
                    ...
                    listedWallets.length ? (react_1.default.createElement(react_1.default.Fragment, null,
                        react_1.default.createElement("span", { className: "wallet-adapter-modal-title" }, "Connect Wallet"),
                        react_1.default.createElement("div", null,
                            react_1.default.createElement("span", { className: "wallet-adapter-modal-subtitle" }, "You need to connect a Solana wallet.")),
                        react_1.default.createElement("hr", { className: "wallet-adapter-modal-line" }),
                        defaultWallet && (react_1.default.createElement("div", { className: "wallet-adapter-modal-list" },
                            react_1.default.createElement(WalletListItem_js_1.WalletListItem, { handleClick: (event) => handleWalletClick(event, defaultWallet === null || defaultWallet === void 0 ? void 0 : defaultWallet.adapter.name), wallet: defaultWallet, isDefault: true }))),
                        listedWallets.length > 1 || collapsedWallets.length ? (react_1.default.createElement(react_1.default.Fragment, null,
                            react_1.default.createElement("button", { className: "wallet-adapter-modal-list-more", onClick: handleCollapseClick, tabIndex: 0 },
                                react_1.default.createElement("span", null, "Other options"),
                            ...
                            expanded && (react_1.default.createElement("ul", { className: "wallet-adapter-modal-list" }, listedWallets.map((wallet) => (react_1.default.createElement(WalletListItem_js_1.WalletListItem, { key: wallet.adapter.name, handleClick: (event) => handleWalletClick(event, wallet.adapter.name), wallet: wallet, isDefault: wallet === defaultWallet }))))))) : null)) : (react_1.default.createElement(react_1.default.Fragment, null,
                        ...
                        collapsedWallets.length ? (react_1.default.createElement(react_1.default.Fragment, null,
                            ...
                            react_1.default.createElement(Collapse_js_1.Collapse, { expanded: expanded, id: "wallet-adapter-modal-collapse" },
                                react_1.default.createElement("ul", { className: "wallet-adapter-modal-list" }, collapsedWallets.map((wallet) => (react_1.default.createElement(WalletListItem_js_1.WalletListItem, { key: wallet.adapter.name, handleClick: (event) => handleWalletClick(event, wallet.adapter.name), tabIndex: expanded ? 0 : -1, wallet: wallet, isDefault: wallet === defaultWallet }))))))) : null)))),

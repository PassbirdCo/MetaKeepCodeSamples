    ...
    <>
        ...
        {defaultWallet && (
            <div className="wallet-adapter-modal-list">
                <WalletListItem
                    handleClick={(event) => handleWalletClick(event, defaultWallet?.adapter.name)}
        ...
        {/* Show "More options" button to display listed + collapsed wallets */}
        {listedWallets.length > 1 || collapsedWallets.length ? (
            <>
                <button
                ...
                {/* Display listed and collapsed wallets when expanded */}
                {expanded && (
